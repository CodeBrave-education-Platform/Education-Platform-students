...
export default function DashboardClient({ 
  ...
  // Student tabs: 'MY_LEARNING' | 'BROWSE'
  // Instructor tabs: 'MY_COURSES' | 'ROSTER'
  ...
  return (
    <div className="relative min-h-screen w-full bg-[#FAF6F2]/30 dark:bg-zinc-950 font-sans transition-colors duration-300">
      
      {/* Premium accent glows */}
      <div className="absolute top-0 right-0 w-[40rem] h-[40rem] bg-indigo-500/5 dark:bg-indigo-950/10 rounded-full blur-[120px] pointer-events-none" />
      <div className="absolute bottom-0 left-0 w-[35rem] h-[35rem] bg-pink-500/5 dark:bg-pink-950/5 rounded-full blur-[150px] pointer-events-none" />
      ...
      <div className="relative z-10 flex min-h-screen">
        ...
        <aside className="w-64 border-r border-zinc-200/50 dark:border-zinc-800/50 bg-white/40 dark:bg-zinc-900/40 backdrop-blur-xl hidden md:flex flex-col p-6 gap-8 justify-between">
          <div className="space-y-8">
            <div className="flex items-center gap-2 font-black text-2xl tracking-tight bg-gradient-to-r from-[#5C3F2F] to-[#B37E5F] dark:from-zinc-100 dark:to-zinc-400 bg-clip-text text-transparent">
              <GraduationCap className="w-6.5 h-6.5 text-[#B37E5F] dark:text-indigo-400" />
              <span>Asentra</span>
            </div>
                  ...
                  <button 
                    ...
                    className={`w-full flex items-center gap-3 px-4 py-3 text-sm font-extrabold rounded-2xl transition-all cursor-pointer ${
                      activeTab === 'MY_COURSES' 
                        ? 'bg-gradient-to-r from-[#F6E5D8] to-[#FAF0E6] text-[#5C3F2F] dark:from-indigo-600/20 dark:to-purple-600/20 dark:text-indigo-400 border-l-4 border-[#B37E5F] dark:border-indigo-500' 
                        : 'text-zinc-600 hover:bg-[#FAF6F2]/40 dark:text-zinc-400 dark:hover:bg-zinc-800/40'
                    }`}
                  >
          ...
          <div className="border-t border-zinc-200/50 dark:border-zinc-800/50 pt-4 flex flex-col gap-3">
            <div className="flex items-center gap-3 px-2">
              <div className="w-10 h-10 rounded-full bg-gradient-to-tr from-[#5C3F2F] to-[#B37E5F] dark:from-indigo-600 dark:to-purple-500 flex items-center justify-center text-white font-extrabold shadow-md">
                {displayName.substring(0, 2).toUpperCase()}
              </div>
              <div className="overflow-hidden">
                <p className="text-sm font-extrabold text-[#3A251B] dark:text-zinc-200 truncate">{displayName}</p>
        ...
        <main className="flex-1 flex flex-col min-h-screen overflow-x-hidden">
          ...
          <header className="p-6 border-b border-zinc-200/50 dark:border-zinc-800/50 bg-white/20 dark:bg-zinc-900/20 backdrop-blur-md flex justify-between items-center">
            <div>
              <h1 className="text-2xl font-black text-[#3A251B] dark:text-zinc-100 tracking-tight">
                {isTeacher ? 'Instructor Control Panel' : 'Student Learning Hub'}
              </h1>
              <p className="text-xs font-semibold text-zinc-400 mt-0.5">
                Dashboard &bull; Signed in as <span className="text-[#B37E5F] dark:text-indigo-400">{user.email}</span>
              </p>
            </div>
            ...
            {isTeacher && (
              <motion.button
                ...
                className="flex items-center gap-2 px-4 py-2.5 bg-gradient-to-r from-[#F6E5D8] to-[#FAF0E6] hover:from-[#F3D7C4] text-[#5C3F2F] dark:bg-gradient-to-r dark:from-indigo-600 dark:via-purple-600 dark:to-pink-600 dark:text-white dark:hover:from-indigo-700 dark:hover:to-pink-700 dark:shadow-indigo-500/20 font-extrabold text-xs rounded-full border border-[#FAF6F2]/60 dark:border-transparent shadow-md cursor-pointer select-none transition-all"
              >
          ...
          <div className="flex-1 p-6 md:p-8 space-y-8 max-w-6xl w-full mx-auto">
            ...
            {/* Dynamic Banner */}
            <div className="p-8 rounded-[2rem] bg-gradient-to-r from-[#5C3F2F] via-[#8C766C] to-[#B37E5F] dark:from-indigo-600 dark:via-purple-600 dark:to-pink-600 text-white relative overflow-hidden shadow-xl shadow-zinc-200/40 dark:shadow-none">
                ...
                return (
                  ...
                  >
                    ...
                    <div>
                      ...
                      <p className="text-xl font-black text-[#3A251B] dark:text-zinc-100 mt-0.5">{stat.value}</p>
                    </div>
                  </div>
                )
              })}
            ...
            >
              ...
              <div className="border-t border-zinc-200/50 dark:border-zinc-800/50 pt-4 mt-6">
                <motion.button
                  ...
                  disabled={createLoading}
                  className="w-full flex items-center justify-center py-3.5 bg-gradient-to-r from-[#F6E5D8] via-[#FAF0E6] to-[#F6E5D8] text-[#5C3F2F] dark:bg-gradient-to-r dark:from-indigo-600 dark:via-purple-600 dark:to-pink-600 dark:text-white dark:hover:from-indigo-700 dark:hover:to-pink-700 font-extrabold rounded-full shadow-md cursor-pointer disabled:opacity-50 transition-all text-xs tracking-wide border border-[#FAF6F2]/60 dark:border-transparent select-none"
                >
                  {createLoading ? (
