# Milestone 1: Courses Bento Grid UI Exploration & Architecture Report
...
3. **Mangled Character Encodings**:
   - In src/app/courses/page.jsx lines 230, 248, 255, 276, 277, 127: corrupted currency symbols (₹ instead of Rupee symbol), corrupted bullets (? instead of bullet), and corrupted emoji (dYZ% instead of celebration emoji).
