-- ============================================================================
-- Migration: 20260530170000_14_schema_integrity_and_qa_patch.sql
...
ALTER TABLE public.invoices
  ...
  CHECK (status IS NULL OR status IN ('success', 'pending', 'failed', 'refunded', 'captured', 'paid'));
