...
- Name: gamification.spec.js >> Gamification and Telemetry Flows >> Gamification HUD displays correct XP and Streak on Dashboard
- Location: tests\gamification.spec.js:27:7
...
Locator: locator('text=Level 2 Ranker')
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for locator('text=Level 2 Ranker')
